...
@Component({
    selector: 'app-icx-estandares',
    templateUrl: './icx-estandares.component.html',
    styleUrls: ['./icx-estandares.component.css'],
    providers: [AdministracionService, OperacionesService]
})
export class IcxEstandaresComponent implements OnInit {
    lstComite: any[] = [];
    lstPrograma: any[] = [];
    token: String = "";
    fechaInicio: String;
